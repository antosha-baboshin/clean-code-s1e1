...
var createNewTaskElement=function(taskString){
    ...
    listItem.classList.add("main__task-list");
    listItem.classList.add("main__task-list_wrapper");
    ...
    deleteButton.className="main__del-btn";
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("main__task-list_edit");
    ...
    listItem.classList.toggle("main__task-list_edit");
};
...
//select ListItems children
    ...
    var deleteButton=taskListItem.querySelector(".main__del-btn");
